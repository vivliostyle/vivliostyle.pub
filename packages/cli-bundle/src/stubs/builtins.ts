 ...
 */
export function $assert(check: any, ...message: any[]): asserts check {
  // NOOP
}
...
export const IS_BUN_DEVELOPMENT: boolean = false;
 ...
 */
export function $getPromiseInternalField<K extends PromiseFieldType, V>(
  promise: Promise<V>,
  key: K,
): PromiseFieldToValue<K, V> {
  throw new Error('Not implemented: $getPromiseInternalField');
}
export function $getInternalField<Fields extends any[], N extends keyof Fields>(
  base: InternalFieldObject<Fields>,
  number: N,
): Fields[N] {
  throw new Error('Not implemented: $getInternalField');
}
/**
...
export function $getProxyInternalField(): TODO {
  throw new Error('Not implemented: $getProxyInternalField');
}
...
export function $isJSArray(obj: unknown): obj is any[] {
  return Array.isArray(obj);
}
export function $isProxyObject(obj: unknown): obj is Proxy {
  throw new Error('Not implemented: $isProxyObject');
}
...
export function $isMap<K, V>(obj: unknown): obj is Map<K, V> {
  return obj instanceof Map;
}
export function $isSet<V>(obj: unknown): obj is Set<V> {
...
export function $isUndefinedOrNull(obj: unknown): obj is null | undefined {
...
export function $putByValDirect(obj: any, key: PropertyKey, value: any): void {
  obj[key] = value;
}
...
export const $promiseStatePending: number = 0;
export const $promiseStateFulfilled: number = 0;
export const $promiseStateRejected: number = 0;
export const $promiseStateMask: number = 0;
// declare const $promiseFlagsIsHandled: number;
// declare const $promiseFlagsIsFirstResolvingFunctionCalled: number;
export const $promiseFieldFlags = 0;
export const $promiseFieldReactionsOrResult = 1;
export const $proxyFieldTarget: TODO = 0;
export const $proxyFieldHandler: TODO = 0;
...
export function $toLength(length: number): number {
  return length;
}
export function $isTypedArrayView(
  obj: unknown,
): obj is ArrayBufferView | DataView | Uint8Array {
 ...
 */
export function $ERR_INVALID_ARG_TYPE(
  argName: string,
  expectedType: string | string[],
  actualValue: any,
): TypeError {
  return new TypeError('ERR_INVALID_ARG_TYPE');
}
export function $ERR_INVALID_ARG_VALUE(
  name: string,
  value: any,
  reason?: string,
): TypeError {
  return new TypeError('ERR_INVALID_ARG_VALUE');
}
export function $ERR_UNKNOWN_ENCODING(enc: string): TypeError {
  return new TypeError('ERR_UNKNOWN_ENCODING');
}
export function $ERR_STREAM_DESTROYED(method: string): Error {
  return new Error('ERR_STREAM_DESTROYED');
}
export function $ERR_METHOD_NOT_IMPLEMENTED(method: string): Error {
  return new Error('ERR_METHOD_NOT_IMPLEMENTED');
}
export function $ERR_STREAM_ALREADY_FINISHED(method: string): Error {
  return new Error('ERR_STREAM_ALREADY_FINISHED');
}
export function $ERR_MISSING_ARGS(...args: [string, ...string[]]): TypeError {
  return new TypeError('ERR_MISSING_ARGS');
}
/**
...
export function $ERR_INVALID_RETURN_VALUE(
  expected_type: string,
  name: string,
  actual_value: any,
): TypeError {
  return new TypeError('ERR_INVALID_RETURN_VALUE');
}
export function $ERR_TLS_INVALID_PROTOCOL_VERSION(
  a: string,
  b: string,
): TypeError {
  return new TypeError('ERR_TLS_INVALID_PROTOCOL_VERSION');
}
export function $ERR_TLS_PROTOCOL_VERSION_CONFLICT(
  a: string,
  b: string,
): TypeError {
  return new TypeError('ERR_TLS_PROTOCOL_VERSION_CONFLICT');
}
export function $ERR_INVALID_IP_ADDRESS(ip: any): TypeError {
  return new TypeError('ERR_INVALID_IP_ADDRESS');
}
export function $ERR_INVALID_ADDRESS_FAMILY(
  addressType,
  host,
  port,
): RangeError {
  return new RangeError('ERR_INVALID_ADDRESS_FAMILY');
}
export function $ERR_OUT_OF_RANGE(
  name: string,
  reason: string,
  value,
): RangeError {
  return new RangeError('ERR_OUT_OF_RANGE');
}
export function $ERR_BUFFER_TOO_LARGE(len: number): RangeError {
  return new RangeError('ERR_BUFFER_TOO_LARGE');
}
export function $ERR_BROTLI_INVALID_PARAM(p: number): RangeError {
  return new RangeError('ERR_BROTLI_INVALID_PARAM');
}
export function $ERR_TLS_CERT_ALTNAME_INVALID(
  reason: string,
  host: string,
  cert,
): Error {
...
export function $ERR_USE_AFTER_CLOSE(name: string): Error {
  return new Error('ERR_USE_AFTER_CLOSE');
}
export function $ERR_HTTP2_INVALID_HEADER_VALUE(
  value: string,
  name: string,
): TypeError {
  return new TypeError('ERR_HTTP2_INVALID_HEADER_VALUE');
}
export function $ERR_INVALID_HANDLE_TYPE(): TypeError {
  return new TypeError('ERR_INVALID_HANDLE_TYPE');
}
export function $ERR_INVALID_HTTP_TOKEN(
  name: string,
  value: string,
): TypeError {
  return new TypeError('ERR_INVALID_HTTP_TOKEN');
}
export function $ERR_HTTP2_STATUS_INVALID(code: number): RangeError {
  return new RangeError('ERR_HTTP2_STATUS_INVALID');
}
export function $ERR_HTTP2_INVALID_PSEUDOHEADER(name: string): TypeError {
  return new TypeError('ERR_HTTP2_INVALID_PSEUDOHEADER');
}
export function $ERR_HTTP2_STREAM_ERROR(code): Error {
  return new Error('ERR_HTTP2_STREAM_ERROR');
}
export function $ERR_HTTP2_SESSION_ERROR(code): Error {
  return new Error('ERR_HTTP2_SESSION_ERROR');
}
export function $ERR_HTTP2_PAYLOAD_FORBIDDEN(status): Error {
  return new Error('ERR_HTTP2_PAYLOAD_FORBIDDEN');
}
export function $ERR_HTTP2_INVALID_INFO_STATUS(code): RangeError {
  return new RangeError('ERR_HTTP2_INVALID_INFO_STATUS');
}
export function $ERR_INVALID_URL(input, base?): TypeError {
  return new TypeError('ERR_INVALID_URL');
}
export function $ERR_INVALID_CHAR(name, field?): TypeError {
  return new TypeError('ERR_INVALID_CHAR');
}
export function $ERR_HTTP_INVALID_HEADER_VALUE(
  value: string,
  name: string,
): TypeError {
  return new TypeError('ERR_HTTP_INVALID_HEADER_VALUE');
}
export function $ERR_HTTP_HEADERS_SENT(action: string): Error {
  return new Error('ERR_HTTP_HEADERS_SENT');
}
export function $ERR_INVALID_PROTOCOL(proto, expected): TypeError {
  return new TypeError('ERR_INVALID_PROTOCOL');
}
export function $ERR_INVALID_STATE(message: string): Error {
  return new Error('ERR_INVALID_STATE');
}
export function $ERR_INVALID_STATE_TypeError(message: string): TypeError {
  return new TypeError('ERR_INVALID_STATE_TypeError');
}
export function $ERR_INVALID_STATE_RangeError(message: string): RangeError {
  return new RangeError('ERR_INVALID_STATE_RangeError');
}
export function $ERR_UNESCAPED_CHARACTERS(arg): TypeError {
  return new TypeError('ERR_UNESCAPED_CHARACTERS');
}
export function $ERR_HTTP_INVALID_STATUS_CODE(code): RangeError {
  return new RangeError('ERR_HTTP_INVALID_STATUS_CODE');
}
export function $ERR_UNHANDLED_ERROR(err?): Error {
  return new Error('ERR_UNHANDLED_ERROR');
}
export function $ERR_BUFFER_OUT_OF_BOUNDS(name?: string): RangeError {
  return new RangeError('ERR_BUFFER_OUT_OF_BOUNDS');
}
export function $ERR_CRYPTO_INVALID_KEY_OBJECT_TYPE(
  value,
  expected,
): TypeError {
  return new TypeError('ERR_CRYPTO_INVALID_KEY_OBJECT_TYPE');
}
export function $ERR_CRYPTO_INCOMPATIBLE_KEY(name, value): Error {
  return new Error('ERR_CRYPTO_INCOMPATIBLE_KEY');
}
export function $ERR_CHILD_PROCESS_IPC_REQUIRED(where): Error {
  return new Error('ERR_CHILD_PROCESS_IPC_REQUIRED');
}
export function $ERR_CHILD_PROCESS_STDIO_MAXBUFFER(message): Error {
  return new Error('ERR_CHILD_PROCESS_STDIO_MAXBUFFER');
}
export function $ERR_INVALID_ASYNC_ID(name, value): RangeError {
  return new RangeError('ERR_INVALID_ASYNC_ID');
}
export function $ERR_ASYNC_TYPE(name): TypeError {
  return new TypeError('ERR_ASYNC_TYPE');
}
export function $ERR_ASYNC_CALLBACK(name): TypeError {
  return new TypeError('ERR_ASYNC_CALLBACK');
}
export function $ERR_AMBIGUOUS_ARGUMENT(arg, message): TypeError {
  return new TypeError('ERR_AMBIGUOUS_ARGUMENT');
}
export function $ERR_INVALID_FD_TYPE(type): TypeError {
  return new TypeError('ERR_INVALID_FD_TYPE');
}
export function $ERR_IP_BLOCKED(ip): Error {
  return new Error('ERR_IP_BLOCKED');
}

export function $ERR_IPC_DISCONNECTED(): Error {
  return new Error('ERR_IPC_DISCONNECTED');
}
export function $ERR_SERVER_NOT_RUNNING(): Error {
  return new Error('ERR_SERVER_NOT_RUNNING');
}
export function $ERR_IPC_CHANNEL_CLOSED(): Error {
  return new Error('ERR_IPC_CHANNEL_CLOSED');
}
export function $ERR_SOCKET_BAD_TYPE(): Error {
  return new Error('ERR_SOCKET_BAD_TYPE');
}
export function $ERR_ZLIB_INITIALIZATION_FAILED(): Error {
  return new Error('ERR_ZLIB_INITIALIZATION_FAILED');
}
export function $ERR_IPC_ONE_PIPE(): Error {
  return new Error('ERR_IPC_ONE_PIPE');
}
export function $ERR_SOCKET_ALREADY_BOUND(): Error {
  return new Error('ERR_SOCKET_ALREADY_BOUND');
}
export function $ERR_SOCKET_BAD_BUFFER_SIZE(): Error {
  return new Error('ERR_SOCKET_BAD_BUFFER_SIZE');
}
export function $ERR_SOCKET_DGRAM_IS_CONNECTED(): Error {
  return new Error('ERR_SOCKET_DGRAM_IS_CONNECTED');
}
export function $ERR_SOCKET_DGRAM_NOT_CONNECTED(): Error {
  return new Error('ERR_SOCKET_DGRAM_NOT_CONNECTED');
}
export function $ERR_SOCKET_DGRAM_NOT_RUNNING(): Error {
  return new Error('ERR_SOCKET_DGRAM_NOT_RUNNING');
}
export function $ERR_INVALID_CURSOR_POS(): Error {
  return new Error('ERR_INVALID_CURSOR_POS');
}
export function $ERR_MULTIPLE_CALLBACK(): Error {
  return new Error('ERR_MULTIPLE_CALLBACK');
}
export function $ERR_STREAM_PREMATURE_CLOSE(): Error {
  return new Error('ERR_STREAM_PREMATURE_CLOSE');
}
export function $ERR_STREAM_NULL_VALUES(): TypeError {
  return new TypeError('ERR_STREAM_NULL_VALUES');
}
export function $ERR_STREAM_CANNOT_PIPE(): Error {
  return new Error('ERR_STREAM_CANNOT_PIPE');
}
export function $ERR_STREAM_WRITE_AFTER_END(): Error {
  return new Error('ERR_STREAM_WRITE_AFTER_END');
}
export function $ERR_STREAM_UNSHIFT_AFTER_END_EVENT(): Error {
  return new Error('ERR_STREAM_UNSHIFT_AFTER_END_EVENT');
}
export function $ERR_STREAM_PUSH_AFTER_EOF(): Error {
  return new Error('ERR_STREAM_PUSH_AFTER_EOF');
}
export function $ERR_STREAM_UNABLE_TO_PIPE(): Error {
  return new Error('ERR_STREAM_UNABLE_TO_PIPE');
}
export function $ERR_ILLEGAL_CONSTRUCTOR(): TypeError {
  return new TypeError('ERR_ILLEGAL_CONSTRUCTOR');
}
export function $ERR_SERVER_ALREADY_LISTEN(): Error {
  return new Error('ERR_SERVER_ALREADY_LISTEN');
}
export function $ERR_SOCKET_CLOSED(): Error {
  return new Error('ERR_SOCKET_CLOSED');
}
export function $ERR_SOCKET_CLOSED_BEFORE_CONNECTION(): Error {
  return new Error('ERR_SOCKET_CLOSED_BEFORE_CONNECTION');
}
export function $ERR_TLS_RENEGOTIATION_DISABLED(): Error {
  return new Error('ERR_TLS_RENEGOTIATION_DISABLED');
}
export function $ERR_UNAVAILABLE_DURING_EXIT(): Error {
  return new Error('ERR_UNAVAILABLE_DURING_EXIT');
}
export function $ERR_TLS_CERT_ALTNAME_FORMAT(): SyntaxError {
  return new SyntaxError('ERR_TLS_CERT_ALTNAME_FORMAT');
}
export function $ERR_TLS_SNI_FROM_SERVER(): Error {
  return new Error('ERR_TLS_SNI_FROM_SERVER');
}
export function $ERR_SSL_NO_CIPHER_MATCH(): Error {
  return new Error('ERR_SSL_NO_CIPHER_MATCH');
}
export function $ERR_INVALID_URI(): URIError {
  return new URIError('ERR_INVALID_URI');
}
export function $ERR_HTTP2_PSEUDOHEADER_NOT_ALLOWED(): TypeError {
  return new TypeError('ERR_HTTP2_PSEUDOHEADER_NOT_ALLOWED');
}
export function $ERR_HTTP2_INFO_STATUS_NOT_ALLOWED(): RangeError {
  return new RangeError('ERR_HTTP2_INFO_STATUS_NOT_ALLOWED');
}
export function $ERR_HTTP2_HEADERS_SENT(): Error {
  return new Error('ERR_HTTP2_HEADERS_SENT');
}
export function $ERR_HTTP2_INVALID_STREAM(): Error {
  return new Error('ERR_HTTP2_INVALID_STREAM');
}
export function $ERR_HTTP2_NO_SOCKET_MANIPULATION(): Error {
  return new Error('ERR_HTTP2_NO_SOCKET_MANIPULATION');
}
export function $ERR_HTTP2_SOCKET_UNBOUND(): Error {
  return new Error('ERR_HTTP2_SOCKET_UNBOUND');
}
export function $ERR_HTTP2_MAX_PENDING_SETTINGS_ACK(): Error {
  return new Error('ERR_HTTP2_MAX_PENDING_SETTINGS_ACK');
}
export function $ERR_HTTP2_INVALID_SESSION(): Error {
  return new Error('ERR_HTTP2_INVALID_SESSION');
}
export function $ERR_HTTP2_TRAILERS_ALREADY_SENT(): Error {
  return new Error('ERR_HTTP2_TRAILERS_ALREADY_SENT');
}
export function $ERR_HTTP2_TRAILERS_NOT_READY(): Error {
  return new Error('ERR_HTTP2_TRAILERS_NOT_READY');
}
export function $ERR_HTTP2_SEND_FILE(): Error {
  return new Error('ERR_HTTP2_SEND_FILE');
}
export function $ERR_HTTP2_SEND_FILE_NOSEEK(): Error {
  return new Error('ERR_HTTP2_SEND_FILE_NOSEEK');
}
export function $ERR_HTTP2_PUSH_DISABLED(): Error {
  return new Error('ERR_HTTP2_PUSH_DISABLED');
}
export function $ERR_HTTP2_HEADERS_AFTER_RESPOND(): Error {
  return new Error('ERR_HTTP2_HEADERS_AFTER_RESPOND');
}
export function $ERR_HTTP2_STATUS_101(): Error {
  return new Error('ERR_HTTP2_STATUS_101');
}
export function $ERR_HTTP2_ALTSVC_INVALID_ORIGIN(): TypeError {
  return new TypeError('ERR_HTTP2_ALTSVC_INVALID_ORIGIN');
}
export function $ERR_HTTP2_INVALID_ORIGIN(): TypeError {
  return new TypeError('ERR_HTTP2_INVALID_ORIGIN');
}
export function $ERR_HTTP2_ALTSVC_LENGTH(): TypeError {
  return new TypeError('ERR_HTTP2_ALTSVC_LENGTH');
}
export function $ERR_HTTP2_PING_LENGTH(): RangeError {
  return new RangeError('ERR_HTTP2_PING_LENGTH');
}
export function $ERR_HTTP2_OUT_OF_STREAMS(): Error {
  return new Error('ERR_HTTP2_OUT_OF_STREAMS');
}
export function $ERR_HTTP_BODY_NOT_ALLOWED(): Error {
  return new Error('ERR_HTTP_BODY_NOT_ALLOWED');
}
export function $ERR_HTTP_SOCKET_ASSIGNED(): Error {
  return new Error('ERR_HTTP_SOCKET_ASSIGNED');
}
export function $ERR_DIR_CLOSED(): Error {
  return new Error('ERR_DIR_CLOSED');
}
export function $ERR_INVALID_MIME_SYNTAX(
  production: string,
  str: string,
  invalidIndex: number | -1,
): TypeError {
  return new TypeError('ERR_INVALID_MIME_SYNTAX');
}
export function $ERR_SOCKET_CONNECTION_TIMEOUT(): Error {
  return new Error('ERR_SOCKET_CONNECTION_TIMEOUT');
}
// declare function $ERR_INVALID_HANDLE_TYPE(): TypeError;
export function $ERR_TLS_HANDSHAKE_TIMEOUT(): Error {
  return new Error('ERR_TLS_HANDSHAKE_TIMEOUT');
}
export function $ERR_VM_MODULE_STATUS(reason: string): Error {
  return new Error('ERR_VM_MODULE_STATUS');
}
export function $ERR_VM_MODULE_ALREADY_LINKED(): Error {
  return new Error('ERR_VM_MODULE_ALREADY_LINKED');
}
export function $ERR_VM_MODULE_CANNOT_CREATE_CACHED_DATA(): Error {
  return new Error('ERR_VM_MODULE_CANNOT_CREATE_CACHED_DATA');
}
export function $ERR_VM_MODULE_NOT_MODULE(): Error {
  return new Error('ERR_VM_MODULE_NOT_MODULE');
}
export function $ERR_VM_MODULE_DIFFERENT_CONTEXT(): Error {
  return new Error('ERR_VM_MODULE_DIFFERENT_CONTEXT');
}
export function $ERR_VM_MODULE_LINK_FAILURE(
  message: string,
  cause: Error,
): Error {
  return new Error('ERR_VM_MODULE_LINK_FAILURE');
}
export function $ERR_TLS_ALPN_CALLBACK_WITH_PROTOCOLS(): TypeError {
  return new TypeError('ERR_TLS_ALPN_CALLBACK_WITH_PROTOCOLS');
}
export function $ERR_HTTP2_TOO_MANY_CUSTOM_SETTINGS(): Error {
  return new Error('ERR_HTTP2_TOO_MANY_CUSTOM_SETTINGS');
}
export function $ERR_HTTP2_CONNECT_AUTHORITY(): Error {
  return new Error('ERR_HTTP2_CONNECT_AUTHORITY');
}
export function $ERR_HTTP2_CONNECT_SCHEME(): Error {
  return new Error('ERR_HTTP2_CONNECT_SCHEME');
}
export function $ERR_HTTP2_CONNECT_PATH(): Error {
  return new Error('ERR_HTTP2_CONNECT_PATH');
}
export function $ERR_HTTP2_TOO_MANY_INVALID_FRAMES(): Error {
  return new Error('ERR_HTTP2_TOO_MANY_INVALID_FRAMES');
}
export function $ERR_HTTP2_PING_CANCEL(): Error {
  return new Error('ERR_HTTP2_PING_CANCEL');
}
...
export function $toClass(
  fn: Function,
  name: string,
  base?: Function | undefined | null,
) {
  if (typeof base === 'function') {
    Object.setPrototypeOf(fn.prototype, base.prototype);
    Object.setPrototypeOf(fn, base);
  }
